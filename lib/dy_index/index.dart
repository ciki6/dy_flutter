...
class _DyIndexPageState extends State<DyIndexPage> with DYBase {
              ...
              child: new Column(
                children: [
                  ...
                  new Container(
                    // 页面整体滚动容器
                    height:
                        MediaQuery.of(context).size.height - dp(80.0 + 40.0),
                    child: new ListView(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: <Color>[Color(0xffffffff), Color(0xffff9b7a)],
        ),
      ),
      child: Row(
  ...
  Widget _listTableInfo() {
    ...
    var fontStyle = TextStyle(color: Colors.white, fontSize: 12.0);

    liveData.forEach((item) {
      liveList.add(GestureDetector(
        onTap: () {
          _goToLiveRoom(item);
        },
        child: Padding(
